...
public class MarketHistoryObject {
	...
	public double EarliestSupplyRate() {
		RateObject earliestSupply = (supply_rates.size() > 0) ? supply_rates.get(0) : null;
		
		if (earliestSupply == null) {
			return 0.0f;
		} else {
			return earliestSupply.GetRate();
		}
	}
